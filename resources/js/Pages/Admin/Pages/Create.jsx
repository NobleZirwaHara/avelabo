    ...
    return (
        <AdminLayout>
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Create Page</h2>
                    <p className="text-gray-500 text-sm">Add new static page content</p>
                </div>
                <Link
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6">
                            ...
                            <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-2">
                                <li>• Use slugs like: vendor-guide, privacy-policy</li>
