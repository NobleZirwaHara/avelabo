        ...
        <AdminLayout>
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h2 className="text-2xl font-bold text-heading dark:text-white">Add Category</h2>
                        <p className="text-body">Create a new product category</p>
                    </div>
                    <Link
                    ...
                    <div className="bg-white dark:bg-dark-card rounded-xl shadow-card p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-body mt-1">Leave empty to create a root category</p>
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <p className="text-xs text-body mt-1">Icon class name from your icon library</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 bg-gray-100 dark:bg-dark-body border-0 rounded-lg text-sm focus:ring-2 focus:ring-brand"
                                />
                                <p className="text-xs text-body mt-1">Lower numbers appear first</p>
                            </div>
                        </div>
                    </div>
